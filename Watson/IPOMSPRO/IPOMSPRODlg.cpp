...
BEGIN_MESSAGE_MAP(CIPOMSPRODlg, CDialog)
	...
	ON_BN_CLICKED(IDC_DIY, &CIPOMSPRODlg::OnBnClickedDiy)
	ON_WM_DESTROY()
END_MESSAGE_MAP()
...
void CIPOMSPRODlg::OnBnClickedDiy()
{
	// TODO: 在此添加控件通知处理程序代码
	char buffer[50];
	ShellExecute(NULL,"open","Compiler.exe",NULL,NULL,SW_SHOWNORMAL);
	while(1)
	{
